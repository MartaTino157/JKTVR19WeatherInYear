 ...
 */
class App {
    public void run(){ //void - ничего не возвращает
        //создание зубчатого массива для хранения дней года
        byte n = 0;
        byte min = 0;
        byte max =0;
        ...
        System.out.println("Миниимальная температура в году: "+minT);
        System.out.println("Максимальная температура в году: "+maxT);
        System.out.println("Температура в конкретный день года");
        Scanner scan = new Scanner(System.in);
        System.out.print("Введите месяц: "); int month =scan.nextInt();
        System.out.print("Введите день: "); int day =scan.nextInt();
        System.out.println("В этот день была температура "+tempInYear[month-1][day-1]+" градусов");
    }
}
